...
$("generateBtn").onclick = async () => {
  ...
  try {
    ...
    logEvent(useDemo ? "Evidence board online" : "Live AI scenario received", "g");
...
$("submitBtn").onclick = async () => {
  ...
  try {
    ...
    else { evaluation = await callAPI(key, buildEvaluationPrompt(state.mode), buildEvaluationMessage(state.scenario, gradedText, state.mode)); }
